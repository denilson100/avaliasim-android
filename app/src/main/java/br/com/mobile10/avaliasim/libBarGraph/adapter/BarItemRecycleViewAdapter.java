package br.com.mobile10.avaliasim.libBarGraph.adapter;
...
public class BarItemRecycleViewAdapter extends RecyclerView.Adapter<BarItemRecycleViewAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        ...
        int valor1 = viewModel.getValue1().intValue();
        holder.txtValue1.setText("" + valor1);
        ...
        if (viewModel.getValue2() != null && viewModel.getValue2() >= 0) {
            int valor2 = viewModel.getValue2().intValue();
            holder.txtValue2.setText("" + valor2);
