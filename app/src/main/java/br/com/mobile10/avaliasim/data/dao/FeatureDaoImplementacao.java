...
import br.com.mobile10.avaliasim.model.Voto;
import br.com.mobile10.avaliasim.util.Constants;

import static br.com.mobile10.avaliasim.util.Constants.DATA_ATUAL;

/**
 * Created by denmont on 16/04/2018.
 */
@RequiresApi(api = Build.VERSION_CODES.O)
public class FeatureDaoImplementacao {

    private DatabaseReference mDatabase;
    private String currentDate = Instant.ofEpochMilli(DATA_ATUAL)
...
//        String key = mDatabase.child(Constants.DB_ROOT).child("avaliacoes").child(avaliacao.idAvaliacao).child("listAvaliacoes").child(featureAvaliada).child(dataAtual).child(status).child(userId).getKey();
//        Voto voto = new Voto(userId);
//        Map<String, Object> postValuesVoto = voto.toMap();
//
//        Map<String, Object> childUpdates = new HashMap<>();
//
//        String caminhoPrivado = "/" + Constants.DB_ROOT + "/avaliacoes/" + avaliacao.idAvaliacao + "/listAvaliacoes/" + featureAvaliada + "/" + dataAtual + "/" + status + "/";
